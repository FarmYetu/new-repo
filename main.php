...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Plants & trees || Farmnet</title>
         ...
         <div class="row team_columns_carousel_wrapper">
          ...
          if($sql){
              ...
              while($obj = $sql->fetch_object()) {
                ...
                echo '  <a><img src="Farmnet/'.$obj->seedling_img_name.'" width="100%" data-toggle="modal" data-target="#'.$obj->id.'"></a>';    
                ...
                echo '<div class="col-lg-4"><img src="Farmnet/'.$obj->seedling_img_name.'"></div>
