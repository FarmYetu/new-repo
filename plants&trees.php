...
<!-- Header Nav ============================================================== -->
  <div class="header-blue">
    <nav class="navbar navbar-default navigation-clean-search">
      <div class="container">
        <div class="navbar-header"><a class="navbar-brand navbar-link" href="index.php">Farmnet</a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">All Catagories <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="product.php">Plants&trees</a></li>
                <li><a href="product.php">Animals</a></li>
                <li><a href="product.php">Machinery</a></li>
              </ul>
            </li>
          </ul>
...
<!-- Header Nav End --><br>
  ...
  <div class="team_columns_carousel_wrapper">
        ...
        <a href="signup.php"><img src="farmnet/wheat.jpg" style="width:100%;"></a>
      </div>
    </div><br>
  <!-- Product Menu End -->
...
<!-- Index Product ============================================================ -->
      ...
      <div class="container">
         <div class="row team_columns_carousel_wrapper">
          ...
          $sql = $mysqli->query("SELECT * FROM plants&trees");
          ...
          if($sql){
              ...
              while($obj = $sql->fetch_object()) {
                ...
                echo '  <a><img src="assets/product/'.$obj->seedling_img_name.'" width="100%" data-toggle="modal" data-target="#'.$obj->id.'"></a>';    
                echo '<div class="team_columns_item_caption">';
                echo '<h5 data-toggle="modal" data-target="#'.$obj->id.'"><a>'.$obj->seedling_name.'</a></h5>';
                echo '<hr>';
                echo '<h5>ksh'.$obj->price.'</h5>';
                echo '</div>';         
                echo '</div>';
                echo '</div>';
                ...
                echo '<h4 class="modal-title">'.$obj->seedling_name.'</h4>';
                echo '</div>';
                echo '<div class="modal-body">';
                echo '<div class="col-lg-4"><img src="assets/product/'.$obj->seedling_img_name.'"></div>
                               <p><h3>'.$obj->seedling_name.'</h3></p>
                               <p><h4><strong>Description</strong>: '.$obj->seedling_desc.'</h4></p>
                               <p><h3><strong>Price (Per Unit)</strong>: '.'ksh'.$obj->price.'</h3></p>
...
<!-- Index Product End -->
    ...
    <div class="footer-copyright">
      <p><a href="admin_login.php">© 2018-2019 Copyright by Farmnet, All rights reserved</a></p>
        </div>
    </footer>
<!-- Footer End -->
